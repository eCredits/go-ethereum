...
const (
	...
	VersionMeta  = "stable-ecs" // Version metadata to append to the version string
	VersionECS   = 1            // ECS version component of the current release
)
